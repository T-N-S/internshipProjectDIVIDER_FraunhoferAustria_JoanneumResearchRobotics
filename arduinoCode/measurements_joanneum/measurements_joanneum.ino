/* ============================================
    ...
    Sketch for Fraunhofer Austria and Joanneum Research Robotics
    Internship Project 
    Conveyor Belt – Project Divider
    Vinay Bhat, Andrii Zhukov, Matthias Bergner, Matthias Weyrer, Tim Schumann
    ...
    and is being carried out as part of the ICT of the Future program.

    Datalogger for Conveyor Belt
    [This code is used to read and save the data from BME280 sensors, MPU6050 sensors, voltagedividers and current modules]
    Author: T. Schumann, A. Zhukov, V. Bhat
    Date: 2023-07-26
